    ...
    <div class="mx-auto container f-f-p px-4 xl:px-0 py-24">
        ...
        <div class="md:mt-24 f-f-p">
            <div class="hidden md:flex justify-center w-full">
                ...
                >
                    ...
                    <div class="flex mt-12 flex-col items-center lg:items-end md:w-8/12">
                        ...
                        <h2
                            class="text-gray-700 mt-3 pl-3 text-center md:text-right text-base leading-6 tracking-wide"
                        >Lorem ipsum dolor sit amet, consectetur adipiscing quisque in semper lacinia ante vestibulum nunc. Viverra sem ac, tellus viverra lacinia. Cras lacus.</h2>
                    </div>
                    <svg
                        class="mt-24"
                        xmlns="http://www.w3.org/2000/svg"
                ...
                >
                    ...
                    <div class="flex mt-12 flex-col items-center md:items-start md:w-8/12">
                        ...
                        <h2
                            class="text-gray-700 mt-3 text-base leading-6 tracking-wide"
                        >Lorem ipsum dolor sit amet, consectetur adipiscing quisque in semper lacinia ante vestibulum nunc. Viverra sem ac, tellus viverra lacinia. Cras lacus.</h2>
                    </div>
                    <svg
                        class="mt-16"
            ...
            <div class="md:hidden flex flex-col items-center w-full">
                ...
                <div class="mt-10">
                    <h1
                        class="text-2xl text-center tracking-wide font-semibold"
                    >SignUp for an Account</h1>
                    <h2
                        class="text-gray-700 mt-3 text-center text-base leading-6 tracking-wide"
                    >Lorem ipsum dolor sit amet, consectetur adipiscing quisque in semper lacinia ante vestibulum nunc. Viverra sem ac, tellus viverra lacinia. Cras lacus.</h2>
                </div>
                <svg
                    class="my-10"
                ...
                <div class="mt-10">
                    ...
                    <h2
                        class="text-gray-700 mt-3 pl-3 text-center text-base leading-6 tracking-wide"
                    >Lorem ipsum dolor sit amet, consectetur adipiscing quisque in semper lacinia ante vestibulum nunc. Viverra sem ac, tellus viverra lacinia. Cras lacus.</h2>
                </div>
                <svg
                    class="my-10"
