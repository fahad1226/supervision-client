<template>
    <body>
        <Alert
            :open="this.$store.state.alert.open"
            :status="this.$store.state.alert.status"
            :message="this.$store.state.alert.message"
            :color="this.$store.state.alert.color"
        />
        <div class="bg-white">
            <div
            ...
            >
                ...
                >
                    ...
                    <div class="mt-6">
                        ...
                        <input
                            ...
                            :class="
                                v$.user.email.$error
                                    ? 'border border-red-300 appearance-none block w-full px-3 py-2 rounded-md placeholder-gray-400 focus:outline-none focus:shadow-outline-red focus:border-red-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5'
                    ...
                    <div class="mt-8" @click.prevent="login">
                        <button
                            role="button"
                ...
                <div class="xl:w-1/3 md:w-1/2 lg:ml-16 ml-8 md:mt-0 mt-6">
                    <div class="flex items-center space-x-3 lg:pr-16 pr-6">
                        ...
                        />
                        <h2
                            class="text-lg font-semibold font-mono leading-6 text-gray-800 cursor-pointer"
                        >
                            Supervision System
                        </h2>
                    </div>
                    <div class="flex items-start mt-8">
                        ...
                        >
                            Supervision System will
                            monitor and track the final year projects. The
                            system will allow students under a supervisor. The
                            supervisor has to determine project tasks, create a
                            schedule, assign resources, and identify and track
                            issues and risks.
                        </p>
                    </div>
...
export default {
    ...
    created() {
        this.$store.state.alert.open = false;
    },
