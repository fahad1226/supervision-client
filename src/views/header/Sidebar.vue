...
<body class="overflow-x-hidden overflow-y-hidden bg-gray-50">
    ...
    >
        ...
        <div class="xl:mt-6 flex flex-col justify-start items-start px-4 w-full space-y-3 pb-5">
            <div
                class="relative focus:outline-none flex jusitfy-start w-full text-gray-800 rounded items-center border-gray-300 focus:border-gray-400 border"
            >
                <input
                    type="text"
                    placeholder="Search"
            ...
            <button
                class="focus:outline-none flex jusitfy-start hover:text-white focus:bg-indigo-700 focus:text-white hover:bg-indigo-700 text-gray-600 rounded py-3 pl-4 items-center space-x-6 w-full"
            >
                <svg
                    class="fill-stroke"
                    width="24"
        ...
        <div class="mt-6 flex flex-col justify-start items-start px-4 w-full space-y-3 pb-5">
            <button
                class="focus:outline-none flex justify-start items-center hover:text-white focus:bg-indigo-700 focus:text-white hover:bg-indigo-700 text-gray-600 rounded py-3 pl-4 w-full"
            >
